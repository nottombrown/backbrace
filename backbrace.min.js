...
a);return this};a.prototype.remove=function(b,a){this.parent.remove(b,a);return this};a.prototype.get=function(b){return _.select(this.models,function(a){return a.id===b})[0]};a.prototype.getByCid=function(b){return _.select(this.models,function(a){return a.cid===(b.cid||b)})[0]};a.prototype.at=function(a){return this.models[a]};a.prototype.sort=function(a){this.parent.sort(a);return this};a.prototype.pluck=function(a){return _.map(this.models,function(c){return c.get(a)})};a.prototype.reset=function(a,
...
null;a.prototype.filter=null;a.prototype.initialize=function(a){var c;this.autoBind();this.el=$(this.el);this.itemView=a.itemView;this.filter=(c=a.filter)!=null?c:function(){return!0};if(typeof this.filter!=="function")throw"filter: Must be function";if(!this.collection)throw"collection: Must be Backbone.Collection";this.collection=a.collection;this.collection.bind("add",this.onCollectionAdd);this.collection.bind("remove",this.onCollectionRemove);this.collection.bind("reset",this.onCollectionReset);
