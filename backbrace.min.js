...
this.object.bind("change:"+this.property,e(function(){this.indices=this.object.get(this.property);return this.update()},this))}else if(this.indices=null!=a?a.indices:void 0,null==this.indices)throw"Required option: indices (if object, property not provided).";this._bind();this._reset()}g(a,Backbrace.Subset);a.prototype.filterfn=function(a){return 0<=i.call(this.indices,a)};a.prototype._models=function(){return this.parent.filter(e(function(a){var c;return c=a.id,0<=i.call(this.indices,c)},this))};
...
this.activeView=null;if(null!=a.defaultView)return this.onTabChange(a.defaultView)};a.prototype.onTabChange=function(a){var c;null!=(c=this.activeView)&&c.remove();this.activeView=new this.views[a];return this.render()};a.prototype.render=function(){var a;this.el.append(null!=(a=this.activeView)?a.render().el:void 0);return this};return a}();window.Backbrace.TabBarView=function(){function a(){a.__super__.constructor.apply(this,arguments)}g(a,Backbone.View);a.prototype.initialize=function(){var a,
c,d,f;this.autoBind();this._wrapElement();this.tabs={};f=this.el.children("li");for(c=0,d=f.length;c<d;c++)a=f[c],this.tabs[a.id]=$(a);this.activeTab=this.el.children("li").first().attr("id");return this.update()};a.prototype._wrapElement=function(){var a;a=this;this.el.addClass("ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all");this.el.children("li").addClass("ui-state-default ui-corner-top");this.el.wrap('<div class="ui-tabs ui-widget" />');return this.el.children("li").each(function(c,
d){$(d).html("<a>"+$(d).text()+"</a>");return $(d).children("a").click(function(){return a.setTab(d.id)})})};a.prototype.update=function(){this.el.children("li").removeClass("ui-tabs-selected ui-state-active");return this.tabs[this.activeTab].addClass("ui-tabs-selected ui-state-active")};a.prototype.setTab=function(a){if(null!=this.tabs[a])return this.activeTab=a,this.update(),this.trigger("tabchange",a)};a.prototype.getTab=function(){return this.activeTab};return a}();window.Backbrace.buildTabRouter=
function(a,b){var c,d,f,e;c={routes:{}};e=b.views;f=function(b){return c["_tab_"+b]=function(){return a.setTab(b)}};for(d in e)c.routes[d]="_tab_"+d,f(d);return new (Backbone.Router.extend(c))}}).call(this);
