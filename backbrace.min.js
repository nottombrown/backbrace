...
"</a>");return $(d).children("a").click(function(){return a.setTab(d.id)})})};a.prototype.update=function(){this.el.children("li").removeClass("ui-tabs-selected ui-state-active");return this.tabs[this.activeTab].addClass("ui-tabs-selected ui-state-active")};a.prototype.setTab=function(a){if(null!=this.tabs[a])return this.activeTab=a,this.update(),this.trigger("tabchange",a)};a.prototype.getTab=function(){return this.activeTab};return a}();window.Backbrace.buildTabRouter=function(a,b){var c,d,f,e;
c={routes:{}};e=b.views;f=function(b){return c["_tab_"+b]=function(){return a.setTab(b)}};for(d in e)c.routes[d]="_tab_"+d,f(d);return new (Backbone.Router.extend(c))}}).call(this);
