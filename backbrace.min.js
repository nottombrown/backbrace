...
null;a.prototype.filter=null;a.prototype.itemClass="bb-list-item";a.prototype.initialize=function(a){var c;this.autoBind();this.el=$(this.el);this.itemView=a.itemView;this.filter=(c=a.filter)!=null?c:function(){return!0};if(a.itemClass!=null)this.itemClass=a.itemClass;if(typeof this.filter!=="function")throw"filter: Must be function";if(!this.collection)throw"collection: Must be Backbone.Collection";this.collection=a.collection;this.collection.bind("add",this.onCollectionAdd);this.collection.bind("reset",
