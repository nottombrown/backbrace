...
_.functions(Backbone.Model.prototype),_.functions(Backbone.View.prototype)),"render");return _.each(a,e(function(a){if(_.indexOf(b,a)===-1)return this[a]=_.bind(this[a],this)},this))}};_.extend(Backbone.Collection.prototype,h);_.extend(Backbone.Model.prototype,h);_.extend(Backbone.View.prototype,h);window._.supplement=function(a){_.each(Array.prototype.slice.call(arguments,1),function(b){var c,d,f;f=[];for(c in b)d=b[c],f.push(d!==0&&a[c]==null?a[c]=d:void 0);return f});return a};window.Backbrace=
{};window.Backbrace.Subset=function(){function a(b){this.parent=b!=null?b.parent:void 0;this.filterfn=b!=null?b.filterfn:void 0;if(!(this.parent instanceof Backbone.Collection||this.parent instanceof Backbrace.Subset))throw"Required option: parent must be a Collection or Subset.";if(typeof this.filterfn!=="function")throw"Required option: filterfn must be function mapping Model to boolean.";this.options=b;delete this.options.parent;delete this.options.filterfn;this._bindings={};this.models=[];this._bind();
this._reset();this.initialize(this.options)}a.prototype.models=[];a.prototype._bind=function(){this.parent.bind("all",e(function(b,a){switch(b){case "add":case "remove":case "destroy":if(this.filterfn(a))return this._reset(),this.trigger.apply(this,arguments);break;case "error":if(this.filterfn(a))return this.trigger.apply(this,arguments);break;case "reset":return this.update();default:if(b.indexOf("change")===0&&(this.getByCid(a)&&(this.filterfn(a)?this.trigger.apply(this,arguments):(this._reset(),
...
a,arguments)},this))},this));return this.length=this.models.length};a.prototype._models=function(){return _.filter(this.parent.models,this.filterfn)};a.prototype._onModelEvent=function(b,a,d){switch(a){case "add":case "remove":case "destroy":case "reset":case "error":return;default:if(a.indexOf("change")===0)return}if(this.filterfn(b))return this.trigger.apply(this,d)};a.prototype.update=function(){this._reset();this.trigger("reset",this);return this};a.prototype.add=function(b,a){this.parent.add(b,
...
c){this.parent.reset(a,c);return this};a.prototype.fetch=function(a){this.parent.fetch(a);return this};a.prototype.create=function(a,c){return this.parent.create(a,c)};a.prototype.parse=function(a){return a};a.prototype.chain=function(){return this.parent.chain()};return a}();_.supplement(Backbrace.Subset.prototype,Backbone.Collection.prototype);_.each(["forEach","each","map","reduce","reduceRight","find","detect","filter","select","reject","every","all","some","any","include","invoke","max","min",
"sortBy","sortedIndex","toArray","size","first","rest","last","without","indexOf","lastIndexOf","isEmpty"],function(a){return Backbrace.Subset.prototype[a]=function(){return _[a].apply(_,[this.models].concat(_.toArray(arguments)))}});window.Backbrace.IndexedSubset=function(){function a(a){this.autoBind();this.parent=a!=null?a.parent:void 0;if(this.parent==null)throw"Required option: parent";this.object=a!=null?a.object:void 0;this.property=a!=null?a.property:void 0;if(this.object!=null&&this.property!=
null){this.indices=this.object.get(this.property);if(this.indices==null)throw"Object property is not present.";this.object.bind("change:"+this.property,e(function(){this.indices=this.object.get(this.property);return this.update()},this))}else if(this.indices=a!=null?a.indices:void 0,this.indices==null)throw"Required option: indices (if object, property not provided).";this._bindings={};this.models=[];this._bind();this._reset();this.initialize(this.options)}g(a,Backbrace.Subset);a.prototype.filterfn=
function(a){var c;return c=a.id,i.call(this.indices,c)>=0};a.prototype._models=function(){return this.parent.filter(e(function(a){var c;return c=a.id,i.call(this.indices,c)>=0},this))};return a}();window.Backbrace.TableView=function(){function a(){a.__super__.constructor.apply(this,arguments)}g(a,Backbone.View);a.prototype.collection=null;a.prototype.table_options=null;a.prototype.datatable=null;a.prototype.initialize=function(a){this.autoBind();this.el=$(this.el);this.table_options=a.table_options;
this._table_rows={};this.collection.bind("add",this._addItem);this.collection.bind("remove",this._removeItem);this.collection.bind("reset",this.repopulate);return this.collection.bind("change",this._updateItem)};a.prototype.render=function(){this.datatable=this.el.dataTable(this.table_options);this.repopulate();return this};a.prototype.repopulate=function(){this.datatable.fnClearTable();return this.collection.each(this._addItem)};a.prototype._addItem=function(a){var c;c=this.datatable.fnAddData(a.toJSON())[0];
return this._table_rows[a.id]=c};a.prototype._removeItem=function(a){a=this._table_rows[a.id];return a==null?void 0:this.datatable.fnDeleteRow(a)};a.prototype._updateItem=function(a){var c;c=this._table_rows[a.id];if(c!=null)return this.datatable.fnUpdate(a.toJSON(),c),this.trigger("rowchange",c,a.id,this.datatable.fnGetNodes(c))};return a}();window.Backbrace.ListView=function(){function a(){a.__super__.constructor.apply(this,arguments)}g(a,Backbone.View);a.prototype.collection=null;a.prototype.itemView=
null;a.prototype.filter=null;a.prototype.itemClass="bb-list-item";a.prototype.initialize=function(a){var c;this.autoBind();this.el=$(this.el);this.itemView=a.itemView;this.filter=(c=a.filter)!=null?c:function(){return!0};if(a.itemClass!=null)this.itemClass=a.itemClass;if(typeof this.filter!=="function")throw"filter: Must be function";if(!this.collection)throw"collection: Must be Backbone.Collection";this.collection=a.collection;this.collection.bind("add",this.onCollectionAdd);this.collection.bind("remove",
this.onCollectionRemove);this.collection.bind("reset",this.onCollectionReset);return this.collection.bind("change",this.onCollectionChange)};a.prototype.onCollectionAdd=function(){return this.render()};a.prototype.onCollectionRemove=function(){return this.render()};a.prototype.onCollectionReset=function(){return this.render()};a.prototype.onCollectionChange=function(){return this.render()};a.prototype.render=function(){this.el.children("."+this.itemClass).remove();_.each(this.collection.filter(this.filter),
this._addItem);return this};a.prototype._addItem=function(a){a.view=new this.itemView({model:a});this.el.append($(a.view.render().el).addClass(this.itemClass));return a.view.trigger("ready")};return a}();window.Backbrace.TabPaneView=function(){function a(){a.__super__.constructor.apply(this,arguments)}g(a,Backbone.View);a.prototype.initialize=function(a){this.autoBind();this.el=$(this.el);this.views=a.views;this.activeView=null;if(a.defaultView!=null)return this.onTabChange(a.defaultView)};a.prototype.onTabChange=
function(a){var c;(c=this.activeView)!=null&&c.remove();this.activeView=new this.views[a];return this.render()};a.prototype.render=function(){var a;this.el.append((a=this.activeView)!=null?a.render().el:void 0);return this};return a}();window.Backbrace.TabBarView=function(){function a(){a.__super__.constructor.apply(this,arguments)}g(a,Backbone.View);a.prototype.initialize=function(){var a,c,d,f;this.autoBind();this._wrapElement();this.tabs={};f=this.el.children("li");c=0;for(d=f.length;c<d;c++)a=
f[c],this.tabs[a.id]=$(a);this.activeTab=this.el.children("li").first().attr("id");return this.update()};a.prototype._wrapElement=function(){var a;a=this;this.el.addClass("ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all");this.el.children("li").addClass("ui-state-default ui-corner-top");this.el.wrap('<div class="ui-tabs ui-widget" />');return this.el.children("li").each(function(c,d){$(d).html("<a>"+$(d).text()+"</a>");return $(d).children("a").click(function(){return a.setTab(d.id)})})};
a.prototype.update=function(){this.el.children("li").removeClass("ui-tabs-selected ui-state-active");return this.tabs[this.activeTab].addClass("ui-tabs-selected ui-state-active")};a.prototype.setTab=function(a){if(this.tabs[a]!=null)return this.activeTab=a,this.update(),this.trigger("tabchange",a)};a.prototype.getTab=function(){return this.activeTab};return a}();window.Backbrace.buildTabRouter=function(a,b){var c,d,f,e;c={routes:{}};e=b.views;f=function(b){return c["_tab_"+b]=function(){return a.setTab(b)}};
for(d in e)c.routes[d]="_tab_"+d,f(d);return new (Backbone.Router.extend(c))}}).call(this);
