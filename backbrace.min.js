...
if("function"!==typeof this.filter)throw"filter: Must be function";if(!this.collection)throw"collection: Must be Backbone.Collection";this.collection=a.collection;this.collection.bind("add",this.onCollectionAdd);this.collection.bind("reset",this.onCollectionReset);return this.collection.bind("change",this.onCollectionChange)};a.prototype.onCollectionAdd=function(){return this.render()};a.prototype.onCollectionReset=function(){return this.render()};a.prototype.onCollectionChange=function(){return this.render()};
